...
describe('Test statistics functionality', () => {
  ...
  test('Test processing of historical statistics [1]', () => {
    ...
    const results = [
      ...
      ['{"time":1644418236973,"work":1,"identifier":"","effort":2.777761938931719,"worker":"QRspi5xuc5oaxfNzJD5Pqr9vMNLbF56L3N.worker1","solo":true,"round":"ff40848b"}',
        '{"time":1644418236974,"work":1,"identifier":"","effort":2.777761938931719,"worker":"QRspi5xuc5oaxfNzJD5Pqr9vMNLbF56L3N.worker2","solo":true,"round":"ff40848b"}'], 0, 1627877085 ];
    const expected = [
      ['zadd', 'Pool1:statistics:primary:historical', 1637877600, '{"time":1637877600000,"hashrate":{"shared":[{"identifier":"","hashrate":28633115.30666667}],"solo":[{"identifier":"","hashrate":28633115.30666667}]},"network":{"difficulty":1.092031593681264,"hashrate":30793089.90778545},"status":{"miners":2,"workers":4}}']];
  ...
  test('Test collection of historical statistics [1]', (done) => {
    ...
    const expected = [
      ['zadd', 'Pool1:statistics:primary:historical', 1637877600, '{"time":1637877600000,"hashrate":{"shared":[{"identifier":"","hashrate":0}],"solo":[{"identifier":"","hashrate":0}]},"network":{"difficulty":0.001978989105730653,"hashrate":52007.68563030699},"status":{"miners":0,"workers":0}}']];
    mockSetupClient(client, commands, 'Pool1', () => {
  ...
  test('Test collection of historical statistics [2]', (done) => {
    ...
    const commands = [
      ['hset', 'Pool1:statistics:primary:network', 'height', 611207]];
    const expected = [
      ['zadd', 'Pool1:statistics:primary:historical', 1637877600, '{"time":1637877600000,"hashrate":{"shared":[{"identifier":"","hashrate":0}],"solo":[{"identifier":"","hashrate":0}]},"network":{"difficulty":0,"hashrate":0},"status":{"miners":0,"workers":0}}']];
    mockSetupClient(client, commands, 'Pool1', () => {
      poolStatistics.handleHistoricalInfo('primary', (output) => {
        expect(output).toStrictEqual(expected);
        done();
